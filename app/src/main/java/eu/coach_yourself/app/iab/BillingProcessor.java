 ...
 */
package eu.coach_yourself.app.iab;
...
public class BillingProcessor extends BillingBase {
    ...
    private void loadPurchasesByTypeAsync(String type, final BillingCache cacheStorage,
        ...
        billingService.queryPurchasesAsync(QueryPurchasesParams.newBuilder()
                .setProductType(type) // or INAPP
            ...
            billingService.queryProductDetailsAsync(params, new ProductDetailsResponseListener() {
                ...
                public void onProductDetailsResponse(@NonNull BillingResult billingResult, @NonNull QueryProductDetailsResult queryProductDetailsResult) {
                    ...
                    if (billingResult.getResponseCode() == BillingClient.BillingResponseCode.OK) {
                        ...
                        startPurchaseFlow(activity, queryProductDetailsResult.getProductDetailsList().get(0), oldProductId);
...
//                    });
    ...
    private void startPurchaseFlow(final Activity activity, final ProductDetails skuDetails, final String oldProductId) {
...
//                billingFlowParamsBuilder.set(skuDetails);

                List<BillingFlowParams.ProductDetailsParams> productDetailsParamsList =
                        List.of(BillingFlowParams.ProductDetailsParams.newBuilder().setProductDetails(skuDetails).build());
                BillingFlowParams.Builder billingFlowParamsBuilder = BillingFlowParams.newBuilder()
                        ...
                        if (detailsList != null && detailsList.size() > 0) {
                            for (ProductDetails skuDetails : detailsList) {
                                try {
                                    ...
                                    object.put("productId", skuDetails.getProductId());
                                    object.put("productType", skuDetails.getProductType());
